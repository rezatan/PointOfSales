    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header with-border">
                ...
                <a href="{{ route('purchase_detail.index') }}" class="btn btn-info btn-xs btn-flat"><i class="fa fa-pencil"></i> Transaksi Aktif</a>
                @endempty
            </div>
...
@includeIf('dashboard.purchase.supplier')
@includeIf('dashboard.purchase.detail')
@endsection
