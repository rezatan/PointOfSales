...
class DashboardController extends Controller
{
    public function index() 
    {
        ...
        return view('dashboard.index', compact('data', 'sale', 'transactions', 'tanggal_awal', 'tanggal_akhir', 'data_tanggal', 'data_pendapatan', 'data_penjualan', 'data_pembelian', 'data_pengeluaran'));
