            ...
            <form action="{{ route('user.update_profile') }}" method="post" class="form-profil" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="username" class="form-control" id="username" required autofocus value="{{ $profile->username }}">
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="email" class="form-control" id="email" required autofocus value="{{ $profile->email }}">
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
